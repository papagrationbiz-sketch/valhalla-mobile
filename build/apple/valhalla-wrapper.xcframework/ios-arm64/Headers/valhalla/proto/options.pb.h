...
class TileOptions final :
 ...
 public:
  ...
  enum : int {
    kReturnShortcutsFieldNumber = 1,
  };
  // bool return_shortcuts = 1;
  void clear_return_shortcuts() ;
  bool return_shortcuts() const;
  void set_return_shortcuts(bool value);

  private:
  bool _internal_return_shortcuts() const;
  void _internal_set_return_shortcuts(bool value);
...
// bool return_shortcuts = 1;
inline void TileOptions::clear_return_shortcuts() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.return_shortcuts_ = false;
}
inline bool TileOptions::return_shortcuts() const {
  // @@protoc_insertion_point(field_get:valhalla.TileOptions.return_shortcuts)
  return _internal_return_shortcuts();
}
inline void TileOptions::set_return_shortcuts(bool value) {
  _internal_set_return_shortcuts(value);
  // @@protoc_insertion_point(field_set:valhalla.TileOptions.return_shortcuts)
}
inline bool TileOptions::_internal_return_shortcuts() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.return_shortcuts_;
}
inline void TileOptions::_internal_set_return_shortcuts(bool value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.return_shortcuts_ = value;
}
